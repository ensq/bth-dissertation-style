...
\begin{changemargin}{+1cm}{+1cm}
        \textbf{Context}. One morning, when Gregor Samsa woke from
        ...
        \textbf{Objectives}. The bedding was hardly able to cover it
        ...
        \textbf{Methods}. It wasn't a dream. His room, a proper human
        room although a little too small, lay peacefully between its
        four familiar walls.

        \textbf{Results}. A collection of textile samples lay spread
        ...
        \textbf{Conclusions}. It showed a lady fitted out with a fur
        ...
        \textbf{Keywords:} 3-4 keywords, maximum 2 of these from the
        title, starts 1 line below the abstract.
\end{changemargin}}
